...
func GetDeployer(runCtx *runcontext.RunContext, provider component.ComponentProvider, labels map[string]string) (deploy.Deployer, error) {
...
*/
func getDefaultDeployer(runCtx *runcontext.RunContext, provider component.ComponentProvider, labels map[string]string) (deploy.Deployer, error) {
