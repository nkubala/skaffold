...
var getNoopProvider = func(config component.KubernetesConfig, labeller *label.DefaultLabeller, podSelector *kubernetes.ImageList, cli *kubectl.CLI) component.Provider {
